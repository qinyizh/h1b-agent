...
import { User, Send, Scale } from "lucide-react";
              ...
              <div
                className={cn(
                  ...
                  message.role === "user"
                    ...
                    : "bg-white border border-stone-200 text-stone-800 font-serif"
                )}
              >
                  ...
                  {message.role === "model" ? (
                    <ReactMarkdown
                      components={{
                        ...
                        code: ({ children }) => (
                          <code className="bg-stone-100 px-1.5 py-0.5 rounded text-sm font-mono">
                            {children}
                          </code>
                        ),
                      }}
